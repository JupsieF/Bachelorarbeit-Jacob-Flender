  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        position={position}
        className={cn(
          'relative z-[1000] max-h-[var(--radix-select-content-available-height)] min-w-[8rem] origin-[var(--radix-select-content-transform-origin)] overflow-x-hidden overflow-y-auto rounded-lg border shadow-lg',
          'bg-white text-popover-foreground dark:bg-gray-800 dark:text-popover-foreground',
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // highlight for keyboard navigation in light mode
        'data-[highlighted]:bg-[var(--color-brand)]/10 data-[highlighted]:text-[var(--color-brand-dark)]',
        // custom dark-mode highlight
        'dark:data-[highlighted]:bg-[var(--color-brand-dark)]/20 dark:data-[highlighted]:text-[var(--color-brand-light)]',
        // hover states
        'hover:bg-[var(--color-brand)]/10 hover:text-[var(--color-brand-dark)]',
        'dark:hover:bg-[var(--color-brand-dark)]/20 dark:hover:text-[var(--color-brand-light)]',
        // focus states
        'focus:bg-[var(--color-brand)]/10 focus:text-[var(--color-brand-dark)]',
        'dark:focus:bg-[var(--color-brand-dark)]/20 dark:focus:text-[var(--color-brand-light)]',
        // disabled
